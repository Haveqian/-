...
import com.qian.gulimallcoupon.service.SmsSkuFullReductionService;
...
public class SmsSkuFullReductionController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimallcoupon:smsskufullreduction:list")
    ...
    //@RequiresPermissions("gulimallcoupon:smsskufullreduction:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimallcoupon:smsskufullreduction:save")
    ...
    //@RequiresPermissions("gulimallcoupon:smsskufullreduction:update")
   ...
   // @RequiresPermissions("gulimallcoupon:smsskufullreduction:delete")
