...
import com.qian.gulimallcoupon.service.SmsHomeSubjectSpuService;
...
public class SmsHomeSubjectSpuController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimallcoupon:smshomesubjectspu:list")
    ...
    //@RequiresPermissions("gulimallcoupon:smshomesubjectspu:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimallcoupon:smshomesubjectspu:save")
    ...
    //@RequiresPermissions("gulimallcoupon:smshomesubjectspu:update")
   ...
   // @RequiresPermissions("gulimallcoupon:smshomesubjectspu:delete")
