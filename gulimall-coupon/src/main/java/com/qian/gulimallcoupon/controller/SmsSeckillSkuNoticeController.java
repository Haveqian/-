...
import com.qian.gulimallcoupon.service.SmsSeckillSkuNoticeService;
...
public class SmsSeckillSkuNoticeController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimallcoupon:smsseckillskunotice:list")
    ...
    //@RequiresPermissions("gulimallcoupon:smsseckillskunotice:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimallcoupon:smsseckillskunotice:save")
    ...
    //@RequiresPermissions("gulimallcoupon:smsseckillskunotice:update")
   ...
   // @RequiresPermissions("gulimallcoupon:smsseckillskunotice:delete")
