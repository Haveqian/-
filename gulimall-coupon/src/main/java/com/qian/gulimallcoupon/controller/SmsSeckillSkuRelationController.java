...
import com.qian.gulimallcoupon.service.SmsSeckillSkuRelationService;
...
public class SmsSeckillSkuRelationController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("gulimallcoupon:smsseckillskurelation:list")
    ...
    //@RequiresPermissions("gulimallcoupon:smsseckillskurelation:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("gulimallcoupon:smsseckillskurelation:save")
    ...
    //@RequiresPermissions("gulimallcoupon:smsseckillskurelation:update")
   ...
   // @RequiresPermissions("gulimallcoupon:smsseckillskurelation:delete")
